...
# @author Don Sawdai
# 
# @videomapping YUYV 640 256 30 YUYV 320 240 30 BeachCitiesRobotics FirstBCRTest
# @email dsawdai@ieee.org
# @address 123 first street, Los Angeles CA 90012, USA
# @copyright Copyright (C) 2018 by Don Sawdai
# @mainurl https://www.bcrobotics.org/
# @supporturl https://www.bcrobotics.org/
# @otherurl https://www.bcrobotics.org/
# @license GPL v3
...
class FirstBCR2020:
    ...
    def detect(self, imgbgr, outimg = None):
        ...
        jevois.drawLine(outimg, int(centroidx),0, int(centroidx),240,2,jevois.YUYV.MedGreen)
        jevois.drawLine(outimg, 0,int(centroidy), 340,int(centroidy),2,jevois.YUYV.MedGreen)
    ...
    def process(self, inframe, outframe):
        ...
        outimg = outframe.get()
        outimg.require("output", w * 2, h + 16, jevois.V4L2_PIX_FMT_YUYV)
